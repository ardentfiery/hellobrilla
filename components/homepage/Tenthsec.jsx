    ...
    <div className="text-white w-[100vw] h-fit relative ">
            ...
            <div className="flex flex-col  gap-5">
              ...
              <div>
                <p className="text-sm foot  text-left">
                  ...
                  <br /> eu aliquam vel facilisi in ante non sed. Enim
                  <br /> adipiscing montes viverra etiam adipiscing aliquet
                  <br /> rhoncus blandit.
                </p>
              </div>
      ...
      <div className="foot bg-[#100c34] text-sm">
        <div className="flex md:ml-6 justify-around  items-center h-[4rem] ">
          <div className="foot">Copyright 2024</div>
          <div className="foot  flex items-center gap-3 md:gap-8 w-[35%] md:w-[8%]">
            <p>Terminos</p>
            <p className="mt-0">Privacidad</p>
          </div>
        </div>
      </div>
    </div>
